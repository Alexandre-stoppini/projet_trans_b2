...
//         exec("rm /var/www/git-stuward/webhook.log");
        ...
        exec("cd /var/www/html/ && git clone ssh://NoYouCanNot@github.com/Alexandre-stoppini/projet_trans_b2.git && echo $(date) ' : Success' >> ./webhook.log || echo $(date)' : Error' >> ./webhook.log");
