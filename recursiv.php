...
function explore($path)
{
    ...
    for ($i = 0; $i < count($chemin_array); $i++) {
        ...
        if (preg_match('/(\.)/', $chemin_array[$i])) {
            ...
            echo "<div class='file'><span><br>Votre fichier à télécharger : </span>" . $foo[count($foo)-1] . "<a href='/sauvegarde/". $chemin_array[$i] ."' download>
            <svg>
            <path d='M17 12v5H3v-5H1v5a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-5z'/>
            <path d='M10 15l5-6h-4V1H9v8H5l5 6z'/>
            </svg></a></div>";
        } else {
            echo "<div class='dir' ><span><br>" . $chemin_array[$i]."</span></div>";
        }
    }
}
